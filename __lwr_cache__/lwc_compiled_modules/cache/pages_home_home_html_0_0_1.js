...
const $fragment2 = parseFragment`<button class="slds-button slds-button_neutral${0}"${2}>Cancel</button>`;
const stc0 = {
  key: 1
};
const stc1 = {
...
function tmpl($api, $cmp, $slotset, $ctx) {
  ...
  })])]), api_custom_element("lightning-layout-item", _lightningLayoutItem, stc6, [api_custom_element("lightning-card", _lightningCard, stc7, [api_custom_element("components-datatable", _componentsDatatable, {
    props: {
  ...
  })])]), api_custom_element("lightning-layout-item", _lightningLayoutItem, stc8, [api_custom_element("lightning-card", _lightningCard, stc9, [$cmp.chartData ? api_fragment(13, [api_custom_element("components-chartbox", _componentsChartbox, {
    props: {
      "chartRecords": $cmp.chartData
    },
    key: 14
  })], 0) : null])]), api_custom_element("lightning-layout-item", _lightningLayoutItem, stc10, [api_custom_element("lightning-card", _lightningCard, stc11, [api_element("div", stc12, [api_element("table", stc13, [api_static_fragment($fragment1(), 20), api_element("tbody", stc14, api_iterator($cmp.categoryTableData, function (item) {
    return api_element("tr", {
      key: api_key(22, item.id)
  ...
  }))])])])])])]), $cmp.showModal ? api_fragment(26, [api_custom_element("components-my-modal", _componentsMyModal, {
    props: {
  ...
  })]), api_element("div", stc20, [api_static_fragment($fragment2(), 36, {
    on: {
