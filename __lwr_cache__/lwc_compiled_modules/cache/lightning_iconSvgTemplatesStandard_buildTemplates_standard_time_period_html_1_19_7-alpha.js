...
import _implicitStylesheets from "./time_period.css";

import _implicitScopedStylesheets from "./time_period.scoped.css?scoped=true";
...
tmpl.stylesheetToken = "lwc-21g5f8d781c";
freezeTemplate(tmpl);
