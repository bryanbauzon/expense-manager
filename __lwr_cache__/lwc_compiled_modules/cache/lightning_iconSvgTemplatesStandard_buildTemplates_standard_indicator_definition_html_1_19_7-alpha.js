...
import _implicitStylesheets from "./indicator_definition.css";

import _implicitScopedStylesheets from "./indicator_definition.scoped.css?scoped=true";
...
tmpl.stylesheetToken = "lwc-7ls5q05s491";
freezeTemplate(tmpl);
