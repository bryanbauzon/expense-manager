...
import _tmpl from "./primitiveDatatableCell.html";
import { keyCodes, isRTL } from 'lightning/utilsPrivate';
class PrimitiveDatatableCell extends LightningElement {
  constructor(...args) {
    super(...args);
    ...
    this._actionableElementsCount = void 0;
  }
  get hasFocus() {
...
_registerDecorators(PrimitiveDatatableCell, {
  publicProps: {
    rowKeyValue: {
      config: 0
    },
  ...
  fields: ["_hasFocus", "_mode", "_currentInputIndex", "_internalTabIndex", "_actionableElementsCount"]
});
export default _registerComponent(PrimitiveDatatableCell, {
  tmpl: _tmpl,
  sel: "lightning-primitive-datatable-cell",
  apiVersion: 59
});