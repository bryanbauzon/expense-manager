...
import _implicitStylesheets from "./indicator_result.css";

import _implicitScopedStylesheets from "./indicator_result.scoped.css?scoped=true";
...
tmpl.stylesheetToken = "lwc-5d10o8b6jok";
freezeTemplate(tmpl);
